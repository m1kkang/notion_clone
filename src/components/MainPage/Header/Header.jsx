...
import ProductBtn from "./Btn/ProductBtn";
import DownloadBtn from "./Btn/DownloadBtn";
import SolutionBtn from "./Btn/SolutionBtn";
import DataBtn from "./Btn/DataBtn";
  ...
  return (
    ...
    >
      ...
      <div className="container flex flex-row items-center justify-end">
        ...
        <button className="bg-black text-white rounded-md w-[167.18px] h-[30px] text-[13.5px] font-semibold hover:bg-neutral-800 ml-[10px]">
          무료로 Notion 사용하기
        </button>
      </div>
    </div>
