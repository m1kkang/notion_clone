...
export default function MainSpace3() {
  return (
    <div className="flex flex-col items-center py-10">
      ...
      <div className="w-[1020.79px] h-[848.53px] bg-neutral-100 rounded-2xl mb-[20px]">
        {/* 아이콘 */}
        <svg
          className="sparkles w-[21.43px] h-[21.93px] block fill-blue-500 mx-6 mt-6 mb-3"
          viewBox="0 0 64 64"
          style={{
            flexShrink: 0,
          }}
        >
          <g>
            <path d="m45.74,33l13,13-13,13-4.24-4.24,5.76-5.76h-7.14c-3.86,0-6.71-1.46-8.95-4.61l-2.71-3.79,3.69-5.16,3.9,5.47c1.12,1.57,2.14,2.09,4.07,2.09h7.14l-5.76-5.76,4.24-4.24Zm-5.62-12h7.14l-5.76,5.76,4.24,4.24,13-13-13-13-4.24,4.24,5.76,5.76h-7.14c-3.86,0-6.71,1.46-8.95,4.61l-15.21,21.3c-1.12,1.57-2.14,2.09-4.07,2.09h-5.88v6h5.88c3.86,0,6.71-1.46,8.95-4.61l15.21-21.3c1.12-1.57,2.14-2.09,4.07-2.09Zm-24.17,2.09l3.9,5.47,3.69-5.16-2.71-3.79c-2.25-3.14-5.09-4.61-8.95-4.61h-5.88v6h5.88c1.92,0,2.95.53,4.07,2.09Z"></path>
          </g>
        </svg>
        <h1 className="mx-6 font-semibold text-lg text-start">
          원하는 방식으로 보기 표시, 필터링, 정렬
        </h1>
        <h1 className="text-start mx-6">
      ...
      <div className="flex flex-row items-center">
        <div className="w-[496.79px] h-[535.91px] bg-neutral-100 rounded-2xl mr-[20px] ml-auto relative">
          {/* 아이콘 */}
          <svg
          ...
          <h1 className="text-start mx-6">
            필요에 맞게 라벨, 태그, 담당자 등을 지정해 모든 사람들이 관 <br />련
            정보를 볼 수 있게 하세요.
          </h1>
          <img
            alt=""
            ...
            decoding="async"
            data-nimg="1"
            className="next-image  absolute rounded-br-2xl w-[464.79px] h-[360.96px]"
            style={{
              color: "transparent",
              objectFit: "cover",
              objectPosition: "top left",
        ...
        <div
          className="w-[496.79px] h-[535.91px] bg-neutral-100 rounded-2xl ml-auto relative
      "
        >
          {/* 아이콘 */}
          <svg
          ...
          <h1 className="text-start mx-6">
            Notion에서는 이미지, 토글, 할 일, 임베드된 데이터베이스까 <br />지
            모든 것이 드래그 & 드롭입니다.
          </h1>
          <img
            alt=""
            ...
            decoding="async"
            data-nimg="1"
            className="next-image  absolute rounded-br-2xl w-[464.8px] h-[360.98px]"
            style={{
              color: "transparent",
              objectFit: "cover",
              objectPosition: "top left",
      ...
      <h1 className="text-2xl mt-9 mb-4">
        "Notion은 니즈에 맞는 커스텀이 가능합니다. 사용자가
        <br />
        원하는 만큼 간단하게 또는 정교하게 만들어 사용할 수
        <br />
        있어요."
      </h1>
      <div className="flex flex-row">
        ...
        <div className="flex flex-col justify-start w-auto">
          <h1 className="text-sm font-semibold text-start">Rahim Makani</h1>
          <h1 className="text-sm">Match Group 프로덕트 디렉터</h1>
        </div>
      </div>
    </div>
  );
